...
LOCAL_MODEL_DEPLOYMENT = {
    ...
    "BASE_IMAGE": os.getenv("CVAT_LOCAL_MODEL_DEPLOYMENT_BASE_IMAGE") or "python:3.10-slim",
    "NO_BASE_IMAGES_PULL": to_bool(
        os.getenv("CVAT_LOCAL_MODEL_DEPLOYMENT_NO_BASE_IMAGES_PULL", False)
    ),
    "PIP_INDEX_URL": os.getenv("CVAT_LOCAL_MODEL_DEPLOYMENT_PIP_INDEX_URL") or "",
    "PIP_EXTRA_INDEX_URL": os.getenv("CVAT_LOCAL_MODEL_DEPLOYMENT_PIP_EXTRA_INDEX_URL") or "",
...
LANGUAGE_CODE = os.getenv("CVAT_LANGUAGE_CODE", "zh-hans")
