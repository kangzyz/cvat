        ...
        return [
            {
                ...
                ("share_preview", "GET"): Scopes.LIST_CONTENT,
                ...
                ("frame_extraction_unsave", "POST"): Scopes.LIST_CONTENT,
...
class ProjectPermission(
    ...
    def _get_scopes(cls, request: ExtendedRequest, view: ViewSet, obj: Project | None):
        ...
        scope = {
            ...
            ("analytics_overview", "GET"): Scopes.VIEW,
            ("analytics_annotations", "GET"): Scopes.VIEW,
            ("analytics_activity", "GET"): Scopes.VIEW,
            ("analytics_events", "GET"): Scopes.VIEW,
            ("analytics_events_export", "POST"): Scopes.VIEW,
