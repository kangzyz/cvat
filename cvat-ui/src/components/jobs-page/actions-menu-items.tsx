...
export default function JobActionsItems(
    ...
    menuItems.push([{
        key: MenuKeys.TASK,
        label: withCount(i18n.t('resources:actions.goToTask'), MenuKeys.TASK, `/tasks/${taskId}`),
    ...
    if (jobsToActWithParents.length && onGoToParent) {
        menuItems.push([{
            ...
            label: withCount(i18n.t('resources:actions.goToParent'), MenuKeys.GO_TO_PARENT),
    ...
    if (jobsToActWithReplicas.length && onGoToReplicas) {
        menuItems.push([{
            ...
            label: withCount(i18n.t('resources:actions.goToReplicas'), MenuKeys.GO_TO_REPLICAS),
    ...
    if (projectId) {
        menuItems.push([{
            ...
            label: withCount(i18n.t('resources:actions.goToProject'), MenuKeys.PROJECT, `/projects/${projectId}`),
    ...
    if (onOpenBugTracker) {
        menuItems.push([{
            ...
            label: withCount(i18n.t('resources:actions.goToBugTracker'), MenuKeys.BUG_TRACKER),
    ...
    menuItems.push([{
        ...
        label: withCount(i18n.t('resources:actions.importAnnotations'), MenuKeys.IMPORT_JOB),
    ...
    menuItems.push([{
        ...
        label: withCount(i18n.t('resources:actions.exportAnnotations'), MenuKeys.EXPORT_JOB),
    ...
    if (onMergeConsensusJob) {
        menuItems.push([{
            ...
            label: withCount(i18n.t('resources:actions.mergeConsensusJob'), MenuKeys.MERGE_SPECIFIC_CONSENSUS_JOBS),
    ...
    menuItems.push([{
        ...
        label: <CVATMenuEditLabel>{withCount(i18n.t('resources:actions.assignee'), MenuKeys.EDIT_ASSIGNEE)}</CVATMenuEditLabel>,
    ...
    menuItems.push([{
        ...
        label: <CVATMenuEditLabel>{withCount(i18n.t('resources:actions.state'), MenuKeys.EDIT_STATE)}</CVATMenuEditLabel>,
    ...
    menuItems.push([{
        ...
        label: <CVATMenuEditLabel>{withCount(i18n.t('resources:actions.stage'), MenuKeys.EDIT_STAGE)}</CVATMenuEditLabel>,
        disabled: isDisabled(MenuKeys.EDIT_STAGE),
    }, 100]);

    menuItems.push([{
        key: MenuKeys.VIEW_ANALYTICS,
        label: withCount(i18n.t('resources:actions.viewAnalytics'), MenuKeys.VIEW_ANALYTICS, `/tasks/${taskId}/jobs/${jobId}/analytics`),
    ...
    if (onDeleteJob) {
        ...
        menuItems.push([{
            key: MenuKeys.DELETE,
            onClick: onDeleteJob,
            label: withCount(i18n.t('resources:actions.delete'), MenuKeys.DELETE),
