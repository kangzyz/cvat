...
const componentShortcuts = {
    CLOCKWISE_ROTATION_STANDARD_CONTROLS: {
        name: '顺时针旋转',
        description: '更改图像角度（增加 90 度）',
        sequences: ['ctrl+r'],
        scope: ShortcutScope.STANDARD_WORKSPACE_CONTROLS,
    },
    ANTICLOCKWISE_ROTATION_STANDARD_CONTROLS: {
        name: '逆时针旋转',
        description: '更改图像角度（减少 90 度）',
