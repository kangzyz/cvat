...
const componentShortcuts = {
    ...
    SWITCH_ALL_HIDDEN: {
        name: '隐藏/显示全部对象',
        description: '更改侧栏中对象的隐藏状态',
        sequences: ['t h'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    SWITCH_HIDDEN: {
        name: '隐藏/显示对象',
        description: '更改活动对象的隐藏状态',
        sequences: ['h'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    SWITCH_OCCLUDED: {
    ...
    SWITCH_KEYFRAME: {
        name: '切换关键帧',
        description: '更改活动轨迹的关键帧属性',
        sequences: ['k'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    SWITCH_OUTSIDE: {
        name: '切换外部属性',
        description: '更改活动轨迹的外部属性',
        sequences: ['o'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    ...
    TO_BACKGROUND: {
        name: '移到背景',
        description: '将活动对象移动到新建的背景图层（降低 Z 顺序值）',
        sequences: ['-', '_'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    TO_FOREGROUND: {
        name: '移到前景',
        description: '将活动对象移动到新建的前景图层（提高 Z 顺序值）',
        sequences: ['+', '='],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    TO_ONE_LAYER_BACKWARD: {
        name: '后移一层',
        description: '将活动对象后移一层（降低 Z 顺序值）',
        sequences: [],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    TO_ONE_LAYER_FORWARD: {
        name: '前移一层',
        description: '将活动对象前移一层（提高 Z 顺序值）',
        sequences: [],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    COPY_SHAPE: {
        name: '复制形状',
        description: '将形状复制到 CVAT 内部剪贴板',
        sequences: ['ctrl+c'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    ...
    CHANGE_OBJECT_COLOR: {
        name: '更改颜色',
        description: '为活动形状设置下一种颜色',
        sequences: ['enter'],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
    SIMPLIFY_POLYGON: {
        name: '简化多边形',
        description: '为选中的多边形或折线启用简化模式',
        sequences: [],
        scope: ShortcutScope.OBJECTS_SIDEBAR,
    },
};
