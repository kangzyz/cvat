...
const componentShortcuts = {
    EDIT_AUDIO_REGION: {
        name: i18n.t('audioPlugins:audio.controls.editIntervalName'),
        description: i18n.t('audioPlugins:audio.controls.editIntervalDescription'),
        sequences: ['e'],
    ...
    return (
        <>
            <GlobalHotKeys
                ...
                handlers={handlers}
            />
            <CVATTooltip title={i18n.t('audioPlugins:audio.controls.editIntervals', { shortcut: editRegionShortkey })} placement='right'>
                <Icon
