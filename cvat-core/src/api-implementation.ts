...
export default function implementAPI(cvat: CVATCore): CVATCore {
    ...
    implementationMixin(cvat.lambda.deleteModel, lambdaManager.deleteModel.bind(lambdaManager));
    ...
    implementationMixin(cvat.server.deleteFrameExtractionSession, async (
        ...args: Parameters<typeof serverProxy.server.deleteFrameExtractionSession>
    ) => {
